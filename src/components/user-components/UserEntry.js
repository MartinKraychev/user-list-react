...
export const UserEntry = ({user, clickHandler}) => {
    return (
        <tr>
            <td>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => clickHandler(user, UserActions.edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => clickHandler(user, UserActions.delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => clickHandler(user, UserActions.details)}>
